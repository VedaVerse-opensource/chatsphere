  ...
  (
    ...
    const handleSend = useCallback(
      async (overrideText, editIndex) => {
        ...
        try {
          ...
          updatedContext[updatedResponses.length] = {
            ...newAIResponse,
            text: fullContent,
          };
    ...
    const getChatResponse = (content, model) => {
      ...
      switch (model) {
        ...
        case "gemini-1.0-pro":
          return gemini10ProResponse(content, model, contextMessages);
